...
By default, the email "from" display address is whatever is before the @. In the example above, that would be "steve". To change the display from, use the format "Steve Smith" <steve@example.com>. For example:
